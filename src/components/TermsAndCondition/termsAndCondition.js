  ...
  return (
    <div className="terms-container">
      <div className="terms-content">
        ...
        <h4>2. Eligibility</h4>
        <p>To purchase Products from our Site, you must be at least 18 years of age or have the consent of a legal guardian.</p>

        <h4>3. Product Information</h4>
        <p>We strive to ensure that the information on our Site is accurate and up-to-date.</p>

        <h4>4. Pricing and Payment</h4>
        <p>All prices on our Site are subject to change without notice. Payment must be made at the time of purchase.</p>

        <h4>5. Order Process</h4>
        <p>After placing an order, you will receive an order confirmation via email.</p>

        <h4>6. Shipping and Delivery</h4>
        <p>Shipping costs and delivery times may vary based on location and shipping method.</p>
